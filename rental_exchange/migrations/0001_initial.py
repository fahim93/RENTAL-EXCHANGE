    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rental_price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=14)),
                ('price_variable', models.CharField(choices=[('Day', 'Day'), ('Month', 'Month'), ('Year', 'Year')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('site_title', models.CharField(default='Rental Exchange', max_length=255)),
                ('site_logo', models.ImageField(upload_to='rental_exchange/system')),
                ('contact_email', models.EmailField(max_length=255)),
                ('contact_phone', models.CharField(max_length=20)),
                ('contact_address', models.CharField(max_length=255)),
                ('email_from', models.EmailField(max_length=255)),
                ('email_from_password', models.CharField(max_length=255)),
                ('email_to', models.EmailField(max_length=255)),
                ('map_url', models.URLField(verbose_name='Map')),
                ...
                ('copyright_year', models.IntegerField(validators=[django.core.validators.MinValueValidator(1984), django.core.validators.MaxValueValidator(2020)])),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
