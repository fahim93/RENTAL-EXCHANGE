# Generated by Django 3.1.2 on 2020-10-10 16:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('rental_exchange', '0003_car_is_featured'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='car',
            name='price_variable',
            field=models.CharField(choices=[('Day', 'Day'), ('Month', 'Month'), ('Year', 'Year')], default='Month', max_length=20),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='rental_exchange/owner_images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(max_length=100)),
                ('address', models.CharField(max_length=255)),
                ('image', models.ImageField(blank=True, null=True, upload_to='rental_exchange/customer_images')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
